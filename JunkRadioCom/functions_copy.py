...
class SingleCommunication():
	def __init__(self, comWireless: str, protocol = Communication):		
		try:
...
if __name__ == "__main__":
	...
	com = SingleCommunication(args.comwireless)

	if not args.transmitter:
		try:
			count = 0
			while count <= 1004:#(com.aliveWireless())
		...
		try:
			while True:#(com.threadWireless.protocol.transport.alive):
				sleep(1)
